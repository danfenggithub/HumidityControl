...
public class editandrun extends StarMacro {
  ...
  private void execute0() {
    ...
    // 37
	velocityMagnitudeProfile_1.getMethod(ConstantScalarProfileMethod.class).getQuantity().setValue(3);
    ...
    // 61
	velocityMagnitudeProfile_3.getMethod(ConstantScalarProfileMethod.class).getQuantity().setValue(2);
